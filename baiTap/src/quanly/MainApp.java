...
public class MainApp {
	public static QuanLySanhCuoi quanLySC;
	public static QuanLyMonAn quanLyMA;
	public static QuanLyDichVu quanLyDV;
	public static QuanLyThoiDiem quanLyTD;
	public static List<DatTiec> listDT = new ArrayList<>();
	public static void main(String[] args){
		Scanner scanner = new Scanner(System.in);
		quanLySC = new QuanLySanhCuoi();
		quanLyMA = new QuanLyMonAn();
		quanLyDV = new QuanLyDichVu();
		quanLyTD = new QuanLyThoiDiem();
		...
		do {
			...
			case 2:
				...
				case 5:
					...
					String tenDVCanTim = scanner.nextLine();
					if(quanLyDV.traCuuDVTheoTen(tenDVCanTim).isEmpty() == true)
						System.out.println("=>Không tìm thấy món ăn trong danh sách");
					else
					{
						System.out.println("=>Thông tin món ăn tìm thấy");
						quanLyDV.traCuuDVTheoTen(tenDVCanTim).forEach(DichVu -> DichVu.showInfo());
					}
					break;
				}
				break;
			...
			case 4:
				...
				case 5:
					scanner.nextLine();
					System.out.print("=>Nhập tên thời điểm cần tìm: ");
					String tenTDCanTim = scanner.nextLine();
					if(quanLyTD.traCuuTDTheoTen(tenTDCanTim).isEmpty() == true)
						System.out.println("=>Không tìm thấy thời điểm trong danh sách");
					else
					{
						System.out.println("=>Thông tin thời điểm tìm thấy");
						quanLyTD.traCuuTDTheoTen(tenTDCanTim).forEach(thoiDiem -> thoiDiem.showInfo());
					}
					break;
				}
				break;
